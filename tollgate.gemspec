...
Gem::Specification.new do |spec|
  ...
  spec.summary       = "Configure a pipeline of checks to run to pass / fail CI"
  spec.description   = "Easy way to integrate static analysers into your local and remote workflows."
